...
export const PREFIX_BINDINGS: PrefixBinding[] = [
  ...
  { action: 'focus-left', key: 'h', group: 'navigation', label: '焦点移到左侧终端', chord: 'Ctrl+B H', implemented: true, modeBar: 'hjkl 焦点' },
  { action: 'focus-down', key: 'j', group: 'navigation', label: '焦点移到下方终端', chord: 'Ctrl+B J', implemented: true },
  { action: 'focus-up', key: 'k', group: 'navigation', label: '焦点移到上方终端', chord: 'Ctrl+B K', implemented: true },
  { action: 'focus-right', key: 'l', group: 'navigation', label: '焦点移到右侧终端', chord: 'Ctrl+B L', implemented: true },
  { action: 'cycle-pane-next', key: 'tab', group: 'navigation', label: '轮换到下一个终端', chord: 'Ctrl+B Tab', implemented: true, modeBar: '⇥ 终端' },
  { action: 'cycle-pane-previous', key: 'shift+tab', group: 'navigation', label: '轮换到上一个终端', chord: 'Ctrl+B Shift+Tab', implemented: true },
  ...
  { action: 'zoom', key: 'z', group: 'pane', label: '最大化终端', chord: 'Ctrl+B Z', implemented: true, modeBar: 'z 缩放' },
  { action: 'close-pane', key: 'x', group: 'pane', label: '关闭当前终端', chord: 'Ctrl+B X', implemented: true, modeBar: 'x 关闭' },
  { action: 'swap-left', key: 'shift+h', group: 'pane', label: '与左侧终端互换', chord: 'Ctrl+B Shift+H', implemented: true },
  { action: 'swap-down', key: 'shift+j', group: 'pane', label: '与下方终端互换', chord: 'Ctrl+B Shift+J', implemented: true },
  { action: 'swap-up', key: 'shift+k', group: 'pane', label: '与上方终端互换', chord: 'Ctrl+B Shift+K', implemented: true },
  { action: 'swap-right', key: 'shift+l', group: 'pane', label: '与右侧终端互换', chord: 'Ctrl+B Shift+L', implemented: true },
  { action: 'rename-pane', key: 'shift+p', group: 'pane', label: '重命名当前终端', chord: 'Ctrl+B Shift+P', implemented: true },
